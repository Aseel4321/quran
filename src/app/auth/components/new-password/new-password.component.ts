...
validation(){
 if(this.repassword.text_password!==''&&this.password!==""&&(this.repassword.text_password==this.password)&&this.num.length==4){return 'active-button';}else{return 'login-button';}}
